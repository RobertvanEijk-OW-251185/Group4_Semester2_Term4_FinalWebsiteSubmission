...
if (document.getElementById('movieCards_Action') || 
    ...
    !async function () {
        ...
        for (let i = 0; i < data.results.length; i++) {
            ...
            movielist.push(new Movies(image, year, title, rating, genrename, description, id));
        }
        ...
        if (document.getElementById('movieCards_Action') || document.getElementById('movieCards_Comedy') || document.getElementById('movieCards_Drama')) {
...
if (document.getElementById('signin-form') || document.getElementById('signup-form')) {
